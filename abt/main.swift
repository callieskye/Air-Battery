...
// Unused elsewhere in this file today (ncFolder below uses AirBatteryModel.key instead), but
// fixed to match the widget's real Bundle Identifier for correctness/future-proofing.
let key = "com.callieskye.AirBattery.widget"
